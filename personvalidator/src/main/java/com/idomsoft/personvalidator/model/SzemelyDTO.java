...
public class SzemelyDTO implements Serializable {
    ...
    public SzemelyDTO(@NotBlank String visNev, @NotBlank String szulNev, @NotBlank String aNev,
                      @NotNull Date szulDat, @NotBlank String neme, @NotBlank String allampKod) {
        this.visNev = visNev;
